  ...
  return (
    <footer className="bg-white border-t border-slate-200 mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="space-y-2.5 md:col-span-2">
            ...
            <p className="text-xs sm:text-sm text-slate-500 max-w-sm leading-relaxed">
              Evidence-based deepfake forensics powered by an 86.5M parameter Vision Transformer and secondary boundary neural networks.
            </p>
          </div>
        ...
        <div className="pt-6 mt-8 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-slate-500">
          <p>© {new Date().getFullYear()} DeepSentry AI Forensics. All rights reserved.</p>
          <div className="flex items-center gap-3">
            <span>60/40 Calibrated Ensemble</span>
            <span>•</span>
